...
public class updatePatientRecord extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Any Major Disease occured earlier");
	...
	try{
	    Connection con = ConnectionProvider.getCon();
            ...
            ResultSet rs=status.executeQuery("select *from patient where patientID = '"+patientID+"'");
            if(rs.next()){
	...
	try{
            ...
            status.executeUpdate("update patient set name='"+name+"', contact='"+contact+"', age='"+age+"', gender='"+gender+"', bloodGroup='"+bloodGroup+"',address='"+address+"', diseases='"+diseases+"' where patientID='"+patientID+"'");
